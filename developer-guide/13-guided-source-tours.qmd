...
This tour is the concrete entry for Chapter 11 (Terminal UI and interactive
...
| 6 | TUI (Tour 5 / Chapter 11) | Trace one `message_update` from `streamAssistantResponse` through `InteractiveMode.handleEvent` to `AssistantMessageComponent.updateContent` |
