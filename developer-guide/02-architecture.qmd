...
%%| fig-cap: "Runtime dependency direction. An arrow points from a package to the package it imports; lower layers never import higher ones."
flowchart TD
  O["orchestrator (experimental)"] --> CA["coding-agent"]
  CA --> TUI["tui"]
  CA --> AG["agent"]
  CA --> AI["ai"]
  AG --> AI
